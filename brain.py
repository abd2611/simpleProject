...
class LCD_CNN:
    def __init__(self,root):
        ...
        self.root.title("Brain Lesion Detection")

        #img4=Image.open(r"xray/train/Tumor/Y11.jpg")
        ...
        # title Label
        title_lbl=Label(text="Brain Lesion Detection",font=("Helvetica",30,"bold"),bg="black",fg="white",)
    ...
    def test_data(self):
        ...
        def ans():
            if classes>0.5:
                ...
                return("No Tumor Found-Normal")

        messagebox.showinfo("Test Data" , ans())
        img = cv2.imread("xray/val/Tumor/val/graph.png")
		# DISPLAY
